...
public class CustomFilter {
    ...
    private static final int MANUFACTURER_DATAMASK_SELECT = 1;
    ...
    public void build() {
        ...
        beaconLightModel.setUuid(uuid.toString());
        beaconLightModel.setMajor(major.toString());
        beaconLightModel.setMinor(minor.toString());
    }
    ...
    private void buildUuidToFilter(String data, int startDataPosition, int endDataPosition) {
        ...
        for (int hexi = 0; hexi < range * 2; hexi++) {
            uuid[hexi + startDataPosition] = dataCharArray[hexi];
        }

        Log.d("CustomFilter", "buildUuidToFilter: " + uuid.toString());
    }
    ...
    private void buildMajorToFilter(String data, int startDataPosition, int endDataPosition) {
        ...
        for (int hexi = 0; hexi < range * 2; hexi++) {
            major[hexi + startDataPosition] = dataCharArray[hexi];
        }
    ...
    private void buildMinorToFilter(String data, int startDataPosition, int endDataPosition) {
        ...
        for (int hexi = 0; hexi < range * 2; hexi++) {
            minor[hexi + startDataPosition] = dataCharArray[hexi];
        }
